...
import type { PreviewTab, Tab } from "@/features/workspace-core/tabs";
import { useEffect, useRef } from "react";
import { WorkspacePreviewPane, type PreviewPaneHandle } from "./WorkspacePreviewPane";
...
export function WorkspacePreviewStack({
  tabs,
  activeId,
  onUrlChange,
  registerHandle,
