...
import { labelFor, type Tab, TabIcon } from "@/features/workspace-core/tabs";
import {
  ArrowDown01Icon,
  ArrowRight01Icon,
  Cancel01Icon,
...
import { WorkspaceSpaceAvatar } from "./WorkspaceSpaceAvatar";
  ...
  return (
    <div className={cn("relative", isDragging && "opacity-50")}>
      ...
      >
        ...
        <WorkspaceSpaceAvatar space={space} size="sm" active={isActive} />
        {editing ? (
          <InlineRename
            initial={space.name}
