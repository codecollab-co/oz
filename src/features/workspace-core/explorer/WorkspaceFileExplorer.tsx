...
import { ExplorerSearchInput, type ExplorerSearchHandle } from "./ExplorerSearchInput";
import { EntryRow, PendingRow, StatusRow, type RowActions } from "./ExplorerTreeRow";
...
import { useGlobalShortcuts } from "@/features/layout-chrome/shortcuts";
import { usePreferencesStore } from "@/features/layout-chrome/settings/preferences";
import type { GitStatusSnapshot } from "@/features/ai-companion/ai/lib/native";
...
export const WorkspaceFileExplorer = memo(
  forwardRef<FileExplorerHandle, Props>(function WorkspaceFileExplorer(
    {
      rootPath,
      activeFilePath,
      onOpenFile,
