import type { SearchTarget } from "@/features/layout-chrome/header";
import { MAX_PANES_PER_TAB, type Tab } from "@/features/workspace-core/tabs";
import { leafIds } from "@/features/shell-pty/terminal";
import {
  Cancel01Icon,
