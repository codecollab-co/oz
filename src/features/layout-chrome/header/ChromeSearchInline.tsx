...
import type { EditorPaneHandle } from "@/features/code-pane/editor";
import { usePreferencesStore } from "@/features/layout-chrome/settings/preferences";
import { getBindingTokens, SHORTCUTS } from "@/features/layout-chrome/shortcuts/shortcuts";
...
export const ChromeSearchInline = forwardRef<SearchInlineHandle, Props>(
  function ChromeSearchInline({ target, compact }, ref) {
