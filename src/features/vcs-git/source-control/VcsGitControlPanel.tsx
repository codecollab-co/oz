...
import {
  copyToClipboard,
  revealInFinder,
} from "@/features/workspace-core/explorer/lib/contextActions";
import { fileIconUrl } from "@/features/workspace-core/explorer/lib/iconResolver";
import {
  COMPACT_CONTENT,
  COMPACT_ITEM,
} from "@/features/workspace-core/explorer/lib/menuItemClass";
import { joinPath } from "@/features/workspace-core/explorer/lib/useFileTree";
import {
...
export const VcsGitControlPanel = memo(function VcsGitControlPanel({
  open,
  sourceControl,
  onOpenGitGraph,
  onOpenDiff,
