...
import { PtyBlockOverlay } from "./block/PtyBlockOverlay";
import { PtyBlockWatermark } from "./block/PtyBlockWatermark";
import {
  focusLeafInput,
  submitToLeaf,
  usePtyTerminalSession,
...
export const PtyTerminalPane = memo(
  forwardRef<TerminalPaneHandle, Props>(function PtyTerminalPane(
    {
      leafId,
      visible,
      focused = true,
    ...
    const session = usePtyTerminalSession({
      leafId,
