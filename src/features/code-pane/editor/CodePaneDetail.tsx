import { getCustomEndpointKey, getKey } from "@/features/ai-companion/ai/lib/keyring";
...
import { useCodeEditorTheme } from "./lib/useCodeEditorTheme";
...
export const CodePaneDetail = forwardRef<EditorPaneHandle, Props>(
  function CodePaneDetail(props, ref) {
    ...
    const themeExt = useCodeEditorTheme();
